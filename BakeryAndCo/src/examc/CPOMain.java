...
//		----------------------------------------------- 31부터 188까지
//		System.out.println(" 메뉴선택 입력 >>");
		String smenu;
		
		while (true) {
			System.out.println("        -- Test Ver. -- ");
			System.out.println("-- Bread & Co. Main Menu -----");
			System.out.println("[1] Cust 회원가입 s");
			System.out.println("[2] Cust 로그인s");
			System.out.println("[3] Cust 부분조회s");
			System.out.println("[4] Cust 전체조회s");
			System.out.println("[5] Cust 정보수정s");
			System.out.println("[6] Cust 회원탈퇴s");
